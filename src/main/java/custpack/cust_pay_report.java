 ...
 */
public class cust_pay_report extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Customer Receipts Report</u></html>");
        setTitle("Customer Receipts Report");
    ...
    public final void load_list_table() {
        ...
        s2.addColumn("Discount");
        s2.addColumn("Net Amount");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            while (r.next()) {
                ...
                s2.addRow(new Object[]{r.getString(1), r.getString(2), r.getString(3), r.getString(4), r.getString(5), sub2, dis2, net2, r.getString(7), r.getString(8), r.getString(9), r.getString(10)});
                selva = true;
            ...
            String sub2 = String.format("%." + hmany + "f", nsub);
            String dis2 = String.format("%." + hmany + "f", ndis);
            String net2 = String.format("%." + hmany + "f", nnet);
            if (selva == true) {
                s2.addRow(new Object[]{"", "", "", "", "", "", "", "", "", "", "", ""});
                s2.addRow(new Object[]{"", "", "", "", "TOTAL:" + (jTable1.getRowCount() - 1), "" + sub2, dis2, net2, "", "", "", ""});
    ...
    public cust_pay_report(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Customer Receipts Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "CustomerReceipts.xlsx";
