 ...
 */
public class cust_list_area extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Area Wise Customer List</u></html>");

        setTitle("Area Wise Customer List");
    ...
    void load_report() {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select cid,ctype,cname,cardno,mobile,add1,add2,add3,city,phone,email,gstno,sname,scode,climit,duedays,remarks from cust where city='" + h3.getSelectedItem() + "' order by cid";
            }
    ...
    public cust_list_area(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Area Wise Customer List");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "AreaWiseCustomerList.xlsx";
