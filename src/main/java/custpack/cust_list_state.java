 ...
 */
public class cust_list_state extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>State Wise Customer List</u></html>");

        setTitle("State Wise Customer List");
    ...
    void load_report() {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select cid,ctype,cname,cardno,mobile,add1,add2,add3,city,phone,email,gstno,sname,scode,climit,duedays,remarks from cust where sname='" + h3.getSelectedItem() + "' order by cid";
            }
    ...
    public cust_list_state(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("State Wise Customer List");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "StateWiseCustomerList.xlsx";
