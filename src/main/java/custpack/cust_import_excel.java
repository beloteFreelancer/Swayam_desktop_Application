 ...
 */
public class cust_import_excel extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Customer List Bulk Upload</u></html>");

        setTitle("Customer List Bulk Upload");
    ...
    public final void load_list_table() {
        ...
        s2.addColumn("Address_Line1");
        s2.addColumn("Address_Line2");
        s2.addColumn("Address_Line3");
        s2.addColumn("City_Area");
    ...
    void save() {
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                String ctype = jTable1.getValueAt(i, 1).toString();
                String cname = jTable1.getValueAt(i, 2).toString();
                String card_no = jTable1.getValueAt(i, 3).toString();
                String mobile = jTable1.getValueAt(i, 4).toString();
                String add1 = jTable1.getValueAt(i, 5).toString();
                String add2 = jTable1.getValueAt(i, 6).toString();
                String add3 = jTable1.getValueAt(i, 7).toString();
                String area = jTable1.getValueAt(i, 8).toString();
                String phone = jTable1.getValueAt(i, 9).toString();
                String email = jTable1.getValueAt(i, 10).toString();
                String gstno = jTable1.getValueAt(i, 11).toString();
                String state = jTable1.getValueAt(i, 12).toString();
                String scode = jTable1.getValueAt(i, 13).toString();
                String climit = jTable1.getValueAt(i, 14).toString();
                String ddays = jTable1.getValueAt(i, 15).toString();
                String remarks = jTable1.getValueAt(i, 16).toString();
                query_list.add("insert into cust values ('" + cid + "','" + ctype + "','" + card_no + "','" + cname + "','" + add1 + "','" + add2 + "','" + add3 + "','" + area + "','" + mobile + "','" + phone + "','" + gstno + "','" + state + "','" + scode + "','" + climit + "','" + ddays + "','" + remarks + "','" + email + "')");
            }
    ...
    public cust_import_excel(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Customer List Bulk Upload");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "Customer_List_Upload.xlsx";
            ...
            if (jTable1.getRowCount() == 0) {
                ...
                model.addColumn("Customer Card No");
                model.addColumn("Mobile No");
                model.addColumn("Address_Line1");
                model.addColumn("Address_Line2");
                model.addColumn("Address_Line3");
                model.addColumn("City_Area");
                model.addColumn("Alt.Contact.Nos");
                model.addColumn("Email");
                model.addColumn("GSTIN");
                model.addColumn("State");
                model.addColumn("State Code");
                model.addColumn("Credit Limit");
                model.addColumn("Due Days");
