 ...
 */
public final class pay_advance extends javax.swing.JInternalFrame {
    ...
    void button_short() {
        ...
        titlelablel.setText("<html><u>Salary Advance Register</u></html>");

        setTitle("Salary Advance Register");
        this.setSize(488, 409);
    ...
    void get_billno() {
        try {
            int sno = 1;
            String query = "select max(sno) from pay_advance";
    ...
    void save() {
        try {
            ...
            boolean selva = false;
            String query = "select sno from pay_advance where sno='" + sno + "'";
            r = util.doQuery(query);
            while (r.next()) {
                selva = true;
            }
            ...
            query = "insert into pay_advance values ('" + sno + "','" + date + "','" + cid + "','" + cname + "','"
                    + amount + "','" + remarks + "','" + last + "')";
    ...
    void view(String sno) {
        try {
            String query = "select sno,date_format(dat,'%d/%m/%Y'),cid,cname,amount,remarks from pay_advance where sno='"
                    + sno + "' ";
            r = util.doQuery(query);
            boolean selva = false;
            while (r.next()) {
    ...
    void delete(String sno) {
        try {
            ...
            query = "delete from pay_advance where sno='" + sno + "'";
    ...
    void get_details() {
        try {
            String amount = "", date = "";
            String query = "select amount,date_format(dat,'%d/%m/%Y') from pay_advance where cid='" + h3.getText()
                    + "'";
            r = util.doQuery(query);
            while (r.next()) {
            ...
            lastl.setText(" Last Advance Amount: " + amount + "    Date: " + date);
        } catch (ClassNotFoundException | SQLException e) {
            System.out.println(e);
        }
    }

    public pay_advance(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        h3.requestFocus();
    ...
    private void initComponents() {
        ...
        jButton10.setIcon(ColorConstants.loadIcon("/icons/close45.png")); // NOI18N
        ...
        titlelablel.setText("Salary Advance Register");
        ...
        closebutton.setBounds(320, 280, 130, 50);
        ...
        savebutton.setBounds(60, 230, 130, 50);
        ...
        viewbutton.setBounds(60, 280, 130, 50);
        ...
        deletebutton.setBounds(60, 230, 130, 50);
        ...
        clearbutton.setBounds(190, 280, 130, 50);
        ...
        h1.setBounds(100, 40, 150, 30);

        h2.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        getContentPane().add(h2);
        h2.setBounds(290, 40, 120, 30);
        ...
        prebutton.setBounds(190, 230, 130, 50);
        ...
        nextbutton.setBounds(320, 230, 130, 50);
        ...
        h5.setBounds(100, 140, 350, 30);

        jLabel13.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel13.setText("Date");
        getContentPane().add(jLabel13);
        jLabel13.setBounds(260, 40, 30, 30);
        ...
        jCalendarButton2.setBounds(410, 40, 40, 30);

        jLabel30.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        jLabel30.setText("Remarks");
        getContentPane().add(jLabel30);
        jLabel30.setBounds(20, 170, 80, 30);
    ...
    private void prebuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_prebuttonActionPerformed
        ...
        try {
            ...
            if (billno.equalsIgnoreCase("--")) {
                query = "select max(sno) from pay_advance";
            } else {
                query = "select sno from pay_advance where sno < '" + billno + "' order by sno desc limit 1";
            }
            r = util.doQuery(query);
            boolean selva = false;
    ...
    private void nextbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_nextbuttonActionPerformed
        ...
        try {
            ...
            query = "select sno from pay_advance where sno > '" + billno + "' order by sno limit 1";
            r = util.doQuery(query);
            boolean selva = false;
            String search_billno = "";
            while (r.next()) {
