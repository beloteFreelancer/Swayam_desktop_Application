 ...
 */
public final class voucher_report_group extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Group Wise Voucher Report</u></html>");
        setTitle("Group Wise Voucher Report");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select distinct billno,date_format(dat,'%d/%m/%Y'),whom,what,amount,pby,account,entry,remarks from account_voucher where dat between ? and ? and under=? order by dat,billno";
                ps = conn.prepareStatement(query);
                ps.setString(1, lk);
                ps.setString(2, lk1);
    ...
    void get_ano() {
        try {
            h3.removeAllItems();
            String query = "select distinct under from account_voucher";
    ...
    public voucher_report_group(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Group Wise Voucher Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "VoucherReportGroup.xlsx";
