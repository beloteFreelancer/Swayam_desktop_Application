 ...
 */
public final class Bankbook_Summary_select extends javax.swing.JInternalFrame {
    ...
    public Bankbook_Summary_select(DataUtil util) {
        initComponents();
    ...
    private void generatebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generatebuttonActionPerformed
        ...
        new Bankbook_Summary().Report(util, h1.getText(), h2.getText());
        this.dispose();
