 ...
 */
public final class RP_select extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Date Selection for RP</u></html>");
        setTitle("Date Selection for RP");
    ...
    public RP_select(DataUtil util) {
        initComponents();
    ...
    private void generatebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generatebuttonActionPerformed
        ...
        new RP().Report(util, h1.getText(), h2.getText());
        this.dispose();
