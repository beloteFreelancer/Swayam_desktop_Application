 ...
 */
public final class voucher_report extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Voucher Report</u></html>");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select distinct billno,date_format(dat,'%d/%m/%Y'),whom,what,amount,pby,account,entry,remarks from account_voucher where dat between ? and ? and entry=? order by dat,billno";
                ps = conn.prepareStatement(query);
                ps.setString(1, lk);
                ps.setString(2, lk1);
    ...
    public voucher_report(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Voucher Report");
        ...
        jLabel11.setText("Entry");
        getContentPane().add(jLabel11);
        jLabel11.setBounds(360, 40, 40, 30);

        h3.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        h3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Debit", "Credit" }));
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "VoucherReport.xlsx";
