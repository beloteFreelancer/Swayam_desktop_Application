 ...
 */
public final class purchase_report_cname extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Supplier Wise Purchase Report</u></html>");
        menu_form me = new menu_form();
        hmany = me.getHmany();
        setTitle("Supplier Wise Purchase Report");
    ...
    public purchase_report_cname(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Supplier Wise Purchase Report");
        ...
        generatebutton.setBounds(800, 40, 200, 30);
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "Supplier_Wise_Purchase_Report.xlsx";
