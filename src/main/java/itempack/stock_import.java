...
public class stock_import extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Stock Bulk Upload</u></html>");

        setTitle("Stock Bulk Upload");
    ...
    void save() {
        try {
            ...
            String barcode = "", ino = "", mrp = "", rprice = "", wprice = "", prate = "", cat = "";
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                String iname = jTable1.getValueAt(i, 0).toString();
                ...
                while (r.next()) {
                    ...
                    ino = r.getString(2);
                    mrp = r.getString(3);
                    rprice = r.getString(4);
                    wprice = r.getString(5);
                    prate = r.getString(6);
                    cat = r.getString(7);
                    shiva = true;
                }
    ...
    public stock_import(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Stock Bulk Upload");
