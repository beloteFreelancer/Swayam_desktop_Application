 ...
 */
public final class sales_report_cashier extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Cashier Wise Sales Report</u></html>");
        setTitle("Cashier Wise Sales Report");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            if (all.isSelected()) {
                query = "select billno,date_format(dat,'%d/%m/%Y'),tim,location,terminal,cashier,items,quans,sub,disp,disamt,gross,taxamt,addamt,net,pby,paid,bal,price_type,cid,cname,mobile,last from sales where dat between '" + lk + "' and '" + lk1 + "' order by cashier,dat,billno";
            } else {
                query = "select billno,date_format(dat,'%d/%m/%Y'),tim,location,terminal,cashier,items,quans,sub,disp,disamt,gross,taxamt,addamt,net,pby,paid,bal,price_type,cid,cname,mobile,last from sales where dat between '" + lk + "' and '" + lk1 + "' and cashier='" + h3.getSelectedItem().toString() + "'  order by dat,billno";
            }
    ...
    void get_location() {
        try {
            h3.removeAllItems();
            String query = "select distinct cashier from sales";
            r = util.doQuery(query);
            while (r.next()) {
    ...
    public sales_report_cashier(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Cashier Wise Sales Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Cashier Wise Sales Report:\n");
