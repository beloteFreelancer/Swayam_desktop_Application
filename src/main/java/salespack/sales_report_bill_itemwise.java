 ...
 */
public final class sales_report_bill_itemwise extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Bill Wise Item Sales</u></html>");
        setTitle("Bill Wise Item Sales");
    ...
    public sales_report_bill_itemwise(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Bill Wise Item Sales");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (Workbook workbook = new XSSFWorkbook()) {
                Sheet sheet = workbook.createSheet("Bill Wise Item Sales");

                // Title and Date Range
                Row titleRow = sheet.createRow(0);
                Cell titleCell = titleRow.createCell(0);
                titleCell.setCellValue("Bill Wise Item Sales");
