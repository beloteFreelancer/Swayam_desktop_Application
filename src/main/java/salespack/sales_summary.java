 ...
 */
public final class sales_summary extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Sales Summary</u></html>");
...
//jTable1.getColumnModel().getColumn(7).setCellRenderer(dtcr);
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            if (all.isSelected()) {
                query = "select billno,date_format(dat,'%d/%m/%Y'),pby,items,quans,net,cid,cname from sales where dat between '" + lk + "' and '" + lk1 + "' order by dat,billno";
            } else {
                query = "select billno,date_format(dat,'%d/%m/%Y'),pby,items,quans,net,cid,cname from sales where dat between '" + lk + "' and '" + lk1 + "' and pby='" + h3.getSelectedItem() + "' order by dat,billno";
            }
    ...
    public sales_summary(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Sales Summary");
