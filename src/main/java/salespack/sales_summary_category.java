 ...
 */
public class sales_summary_category extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Category Wise Sales Summary</u></html>");
        setTitle("Category Wise Sales Summary");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            query = "select cat,sum(quan),sum(amount) from sales_items a,item b where dat between '" + lk + "' and '" + lk1 + "' and a.ino=b.ino group by cat order by cat";
    ...
    public sales_summary_category(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Category Wise Sales Summary");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (Workbook workbook = new XSSFWorkbook()) {
                Sheet sheet = workbook.createSheet("Category Sales Summary");

                // Title and Date Range
                Row titleRow = sheet.createRow(0);
                Cell titleCell = titleRow.createCell(0);
                titleCell.setCellValue("Category Wise Sales Summary");
