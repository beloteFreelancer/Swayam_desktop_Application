...
public class sales_report extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Sales Report</u></html>");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            if (all.isSelected()) {
                query = "select billno,date_format(dat,'%d/%m/%Y'),tim,location,terminal,cashier,items,quans,sub,disp,disamt,gross,taxamt,addamt,net,pby,paid,bal,price_type,cid,cname,mobile,last from sales where dat between '" + lk + "' and '" + lk1 + "' order by dat,billno";
            } else {
                query = "select billno,date_format(dat,'%d/%m/%Y'),tim,location,terminal,cashier,items,quans,sub,disp,disamt,gross,taxamt,addamt,net,pby,paid,bal,price_type,cid,cname,mobile,last from sales where dat between '" + lk + "' and '" + lk1 + "' and pby='" + h3.getSelectedItem().toString() + "'  order by dat,billno";
            }
            ...
            while (r.next()) {
                ...
                String other2 = String.format("%." + hmany + "f", other);
                String net2 = String.format("%." + hmany + "f", net);
                String paid2 = String.format("%." + hmany + "f", paid);
                String bal2 = String.format("%." + hmany + "f", bal);

                s2.addRow(new Object[]{r.getString(1), r.getString(2), r.getString(3), r.getString(4), r.getString(5), r.getString(6), r.getString(7), r.getString(8), sub2, r.getString(10), disamt2, gross2, taxamt2, other2, net2, r.getString(16), paid2, bal2, r.getString(19), "  " + r.getString(20), r.getString(21), r.getString(22), r.getString(23)});
                selva = true;
            }
            sub = 0;
            disamt = 0;
            ...
            if (selva == true) {
                ...
                s2.addRow(new Object[]{"", "", "TOTAL:" + (jTable1.getRowCount() - 1), "", "", "", "", "", "" + sub2, "", disamt2, gross2, taxamt2, other2, net2, "", paid2, bal2, "", "", "", "", ""});
    ...
    public sales_report(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Sales Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            File file = new File(folder + "/Drafts/" + file_name + ".xlsx");
