 ...
 */
public final class tax_hsn_sales_return extends javax.swing.JInternalFrame {
    ...
    void button_short() {
        ...
        titlelablel.setText("<html><u>GSTR - HSN Wise Sales Return</u></html>");

        setTitle("GSTR - HSN Wise Sales Return");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String hsn, iname, udes, ttype;
            double quan, total, value, tax1;

            query = "SELECT hsn, iname, udes, SUM(quan), SUM(total), SUM(sub), tax_type, SUM(taxamt) "
                    + "FROM sreturn_items "
                    + "WHERE dat BETWEEN '" + lk + "' AND '" + lk1 + "' AND entry='purchase' "
                    + "GROUP BY hsn, iname, udes, tax_type "
                    + "ORDER BY hsn, iname";
            ...
            if (r != null) {
                while (r.next()) {
                    ...
                    s2.addRow(new Object[]{hsn, iname, udes, quan1, total1, value1, "", "", "", ""});
                }
            }
    ...
    public tax_hsn_sales_return(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("GSTR - HSN Wise Sales Return");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        if (s2.getRowCount() <= 0) {
            ...
            new ExcelUtilGST(h1.getText(), h2.getText()).GenerateHsnSalesReturnWorkbook();
        }
