 ...
 */
public final class tax_hsn_purchase extends javax.swing.JInternalFrame {
    ...
    void button_short() {
        ...
        titlelablel.setText("<html><u>GSTR - HSN Wise Purchase</u></html>");

        setTitle("GSTR - HSN Wise Purchase");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            query = "select hsn,iname,sum(quan),sum(total),sum(sub) from purchase_items where dat between '" + lk
                    + "' and '" + lk1 + "' group by hsn,iname order by hsn,iname";
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                query = "select sum(taxamt),ttype from purchase_items where dat between '" + lk + "' and '" + lk1
                        + "' and hsn='" + hsn1 + "' and iname='" + iname1 + "' group by ttype";
                r = util.doQuery(query);
                while (r.next()) {
            ...
            s2.addRow(new Object[] { "", "Total", "", "", "" + ntotal1, "" + nvalue1, "" + nigst1, "" + ncgst1,
                    "" + ncgst1, "" });
            if (selva == true) {
                h1.setEnabled(false);
                h2.setEnabled(false);
    ...
    public tax_hsn_purchase(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("GSTR - HSN Wise Purchase");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excelbuttonActionPerformed
        if (s2.getRowCount() <= 0) {
            ...
            new ExcelUtilGST(h1.getText(), h2.getText()).GenerateHsnPurchaseWorkbook();
        }
