...
public final class tax_hsn_purchase extends javax.swing.JInternalFrame {
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            query = "select hsn,iname,sum(quan),sum(total),sum(sub) from purchase_items where dat between '" + lk + "' and '" + lk1 + "' group by hsn,iname order by hsn,iname";
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                query = "select sum(taxamt),ttype from purchase_items where dat between '" + lk + "' and '" + lk1 + "' and hsn='" + hsn1 + "' and iname='" + iname1 + "' group by ttype";
                r = util.doQuery(query);
                while (r.next()) {
