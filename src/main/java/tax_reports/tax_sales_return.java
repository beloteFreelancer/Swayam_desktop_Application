 ...
 */
public final class tax_sales_return extends javax.swing.JInternalFrame {
    ...
    void button_short() {
        ...
        titlelablel.setText("<html><u>GSTR -Sales Return</u></html>");
    }
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            // Replace CID with customer name and GST
            ...
            s2.addRow(new Object[]{"", "", "", "", "", "", "", "", "", "", "", "", ""});
            s2.addRow(new Object[]{
                "", "TOTAL:" + (jTable1.getRowCount() - 1), "", "", "", "", value3,
    ...
    public tax_sales_return(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("GSTR -Sales Return");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        if (s2.getRowCount() <= 0) {
            ...
            new ExcelUtilGST(h1.getText(), h2.getText()).GenerateGstrSalesReturnWorkbook();
        }
