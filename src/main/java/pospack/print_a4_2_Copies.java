...
public class print_a4_2_Copies {
    ...
    public void Report(DataUtil util, String billno, String drive, String folder, String billformat, String copy) {
        this.util = util;
        try {
            ...
            parameters.put("parameter60", copy);
            ...
            JasperReport jasperReport = JasperReportCompiler.compileReport("/JasperFiles/A4/A4_Invoice.jrxml");
