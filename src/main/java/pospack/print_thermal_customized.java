 ...
 */
public class print_thermal_customized {
    ...
    public void Report(DataUtil util, String billno, String drive, String folder, String billformat) {
        try {
            ...
            JasperReport jasperReport = JasperReportCompiler.compileReport("/JasperFiles/Thermal_Unicode/Thermal_GST_Customized.jrxml");
