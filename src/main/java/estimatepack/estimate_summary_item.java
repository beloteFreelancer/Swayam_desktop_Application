 ...
 */
public final class estimate_summary_item extends javax.swing.JInternalFrame {
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            if (all.isSelected()) {
                query = "select ino,iname,sum(quan),sum(amount) from estimate_items where dat between '" + lk + "' and '" + lk1 + "' group by ino order by ino";
            } else {
                query = "select distinct a.ino,a.iname,sum(quan),sum(amount) from estimate_items a,item b where dat between '" + lk + "' and '" + lk1 + "' and cat='" + h3.getSelectedItem() + "' and a.ino=b.ino group by a.ino order by a.ino";
            }
    ...
    public estimate_summary_item(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Item Wise Estimate Summary");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Item Wise Estimate Summary:\n");
