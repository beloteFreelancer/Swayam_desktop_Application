 ...
 */
public class estimate_summary_category extends javax.swing.JInternalFrame {
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            query = "select cat,sum(quan),sum(amount) from estimate_items a,item b where dat between '" + lk + "' and '" + lk1 + "' and a.ino=b.ino group by cat order by cat";
    ...
    public estimate_summary_category(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Category Wise Estimate Summary");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Category Wise Estimate Summary:\n");
