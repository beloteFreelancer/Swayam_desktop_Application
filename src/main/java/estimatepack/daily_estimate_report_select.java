 ...
 */
public class daily_estimate_report_select extends javax.swing.JInternalFrame {
    ...
    public daily_estimate_report_select(DataUtil util) {
        initComponents();
        button_short();
        this.util = util;
    }
    ...
    private void generatebuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generatebuttonActionPerformed
        try {
            ...
            new daily_estimate_report().Report(h1.getText(), h2.getText(), util);
            this.dispose();
        } catch (Exception e) {
