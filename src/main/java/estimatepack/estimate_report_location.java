 ...
 */
public final class estimate_report_location extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Location Wise Estimate Report</u></html>");
        setTitle("Location Wise Estimate Report");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            if (all.isSelected()) {
                query = "select billno,date_format(dat,'%d/%m/%Y'),tim,location,terminal,cashier,items,quans,sub,disp,disamt,gross,taxamt,addamt,net,pby,paid,bal,price_type,cid,cname,mobile,last from estimate where dat between '" + lk + "' and '" + lk1 + "' order by location,dat,billno";
            } else {
                query = "select billno,date_format(dat,'%d/%m/%Y'),tim,location,terminal,cashier,items,quans,sub,disp,disamt,gross,taxamt,addamt,net,pby,paid,bal,price_type,cid,cname,mobile,last from estimate where dat between '" + lk + "' and '" + lk1 + "' and location='" + h3.getSelectedItem().toString() + "'  order by dat,billno";
            }
    ...
    public estimate_report_location(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Location Wise Estimate Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Location Wise Estimate Report:\n");
