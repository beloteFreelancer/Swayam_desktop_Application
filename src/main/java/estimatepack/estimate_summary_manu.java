 ...
 */
public class estimate_summary_manu extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Manufacturer Wise Estimate Summary</u></html>");
        setTitle("Manufacturer Wise Estimate Summary");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            query = "select manu,sum(quan),sum(amount) from estimate_items a,item b where dat between '" + lk + "' and '" + lk1 + "' and a.ino=b.ino group by manu order by manu";
            r = util.doQuery(query);
            while (r.next()) {
                sub = r.getDouble(3);
                String sub1 = String.format("%." + hmany + "f", sub);
                s2.addRow(new Object[]{r.getString(1), r.getString(2), sub1});
                selva = true;
            }
            sub = 0;
    ...
    public estimate_summary_manu(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Manufacturer Wise Estimate Summary");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Manufacturer Wise Estimate Summary:\n");
