 ...
 */
public class profit_billwise extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Bill Wise Profit</u></html>");
    ...
    public final void load_list_table() {
        ...
        jTable1.getColumnModel().getColumn(2).setPreferredWidth(324);
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            boolean selva = false;
            String query;
            query = "select date_format(dat,'%d/%m/%Y'),billno,cname,gross,cost_rate,gross-cost_rate from sales where dat between '" + lk + "' and '" + lk1 + "' order by dat,billno";
    ...
    public profit_billwise(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Bill Wise Profit");
