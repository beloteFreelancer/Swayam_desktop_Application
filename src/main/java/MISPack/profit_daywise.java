 ...
 */
public class profit_daywise extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Day Wise Profit</u></html>");
        setTitle("Day Wise Profit");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            query = "select date_format(dat,'%d/%m/%Y'),min(billno),max(billno),count(billno),sum(gross),sum(cost_rate),sum(gross-cost_rate) from sales where dat between '" + lk + "' and '" + lk1 + "' group by dat order by dat";
            r = util.doQuery(query);
            while (r.next()) {
                String sub = String.format("%." + hmany + "f", r.getDouble(5));
                String cost_rate = String.format("%." + hmany + "f", r.getDouble(6));
                String profit = String.format("%." + hmany + "f", r.getDouble(7));

                s2.addRow(new Object[]{r.getString(1), r.getString(2) + " -" + r.getString(3), r.getString(4), sub, cost_rate, profit});
                selva = true;
            }
    ...
    public profit_daywise(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Day Wise Profit");
