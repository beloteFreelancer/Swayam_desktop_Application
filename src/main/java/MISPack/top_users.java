 ...
 */
public class top_users extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Cashier Wise Sales</u></html>");
        setTitle("Cashier Wise Sales");
    ...
    public final void load_list_table() {
        ...
        jTable1.getColumnModel().getColumn(0).setPreferredWidth(390);
        jTable1.getColumnModel().getColumn(1).setPreferredWidth(204);
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            boolean selva = false;
            String query;
            query = "select cashier,count(billno),sum(quans),sum(net) from sales where dat between '" + lk + "' and '" + lk1 + "' group by cashier order by cashier";
            ...
            while (r.next()) {
                ...
                String amount2 = String.format("%." + hmany + "f", r.getDouble(4));
                s2.addRow(new Object[]{r.getString(1), r.getString(2), quan2, amount2});
                selva = true;
            }
            if (selva == true) {
                h1.setEnabled(false);
    ...
    public top_users(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Cashier Wise Sales");
        ...
        generatebutton.setBounds(360, 40, 190, 30);
