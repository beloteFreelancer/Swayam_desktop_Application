 ...
 */
public class top_selling_items extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Top Selling Items by Qty Wise</u></html>");
        setTitle("Top Selling Items by Qty Wise");
    ...
    public final void load_list_table() {
        ...
        jTable1.getColumnModel().getColumn(1).setPreferredWidth(564);
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            if (all.isSelected()) {
                query = "select ino,iname,sum(quan) from sales_items where dat between ? and ? group by ino, iname order by sum(quan) desc";
                ...
                int limit = 10;
                try {
                     limit = Integer.parseInt(h3.getText());
                } catch (NumberFormatException e) {
                    limit = 10;
                    h3.setText("10");
                }

                query = "select ino,iname,sum(quan) from sales_items where dat between ? and ? group by ino, iname order by sum(quan) desc limit ?";
                ps = conn.prepareStatement(query);
                ps.setString(1, lk);
                ps.setString(2, lk1);
                ps.setInt(3, limit);
            ...
            r = ps.executeQuery();
            while (r.next()) {
                String quan2 = String.format("%." + hmany + "f", r.getDouble(3));
                ...
                s2.addRow(new Object[]{r.getString(1), r.getString(2), quan2});
                selva = true;
            }
            if (selva == true) {
                h1.setEnabled(false);
    ...
    public top_selling_items(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Top Selling Items by Qty Wise");
        ...
        generatebutton.setBounds(650, 40, 190, 30);
        ...
        jLabel14.setBounds(360, 40, 40, 30);
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "TopSellingItems.xlsx";
