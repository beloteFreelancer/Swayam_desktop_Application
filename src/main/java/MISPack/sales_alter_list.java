 ...
 */
public class sales_alter_list extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Altered Sales Bills</u></html>");
        setTitle("Altered Sales Bills");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            boolean selva = false;
            String query = "select billno,date_format(dat,'%d/%m/%Y'),tim,cashier,terminal,cid,cname,pby,amount,newamount,reason,user,last from alter_sales where dat between '" + lk + "' and '" + lk1 + "' order by dat";
    ...
    void delete() {
        try {
            ...
            String last = jTable1.getValueAt(jTable1.getSelectedRow(), 12).toString();
            String query = "delete from alter_sales where billno='" + billno + "' and last='" + last + "' ";
    ...
    public sales_alter_list(DataUtil util) {
        initComponents();
        this.util = util;
        load_list_table();
        button_short();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Altered Sales Bills");
