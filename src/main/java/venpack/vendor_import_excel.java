...
public class vendor_import_excel extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Supplier List Bulk Upload</u></html>");
    ...
    void save() {
        try {
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                ...
                String add1 = jTable1.getValueAt(i, 1).toString();
                String add2 = jTable1.getValueAt(i, 2).toString();
                String add3 = jTable1.getValueAt(i, 3).toString();
                String area = jTable1.getValueAt(i, 4).toString();
                String mobile = jTable1.getValueAt(i, 5).toString();
                String phone = jTable1.getValueAt(i, 6).toString();
                String email = jTable1.getValueAt(i, 7).toString();
                String gstno = jTable1.getValueAt(i, 8).toString();
                String state = jTable1.getValueAt(i, 9).toString();
    ...
    public vendor_import_excel(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Supplier List Bulk Upload");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "Supplier_List_Upload";
