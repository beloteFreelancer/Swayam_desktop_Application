 ...
 */
public class ven_pay_report extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Supplier Payments Report</u></html>");
        setTitle("Supplier Payments Report");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            while (r.next()) {
                ...
                s2.addRow(new Object[] { r.getString(1), r.getString(2), r.getString(3), r.getString(4), sub2,
            ...
            if (selva == true) {
                ...
                s2.addRow(
                        new Object[] { "", "", "", "TOTAL:" + (jTable1.getRowCount() - 1), "" + sub2, "", "", "", "" });
    ...
    public ven_pay_report(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Supplier Payments Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "SupplierPaymentsReport.xlsx";
