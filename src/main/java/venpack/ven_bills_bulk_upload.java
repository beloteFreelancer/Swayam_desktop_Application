 ...
 */
public class ven_bills_bulk_upload extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Supplier Bills Bulk Upload (Opening Balance)</u></html>");

        setTitle("Supplier Bills Bulk Upload (Opening Balance)");
    ...
    public final void load_list_table() {
        ...
        jTable1.getColumnModel().getColumn(1).setPreferredWidth(124);
    ...
    void load_items() {
        try {
            String query;
            query = "select cname,billno,date_format(dat,'%d/%m/%Y'),date_format(ddate,'%d/%m/%Y'),amount,remarks from ven_bill order by sno";
    ...
    void save() {
        try {
            ...
            boolean selva = false;
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                String cname = jTable1.getValueAt(i, 0).toString();
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                String cname = jTable1.getValueAt(i, 0).toString();
                String billno = jTable1.getValueAt(i, 1).toString();
                String bill_date = jTable1.getValueAt(i, 2).toString();
                String due_date = jTable1.getValueAt(i, 3).toString();
    ...
    public ven_bills_bulk_upload(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Supplier Bills Bulk Upload (Opening Balance)");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "Supplier_Bills_Upload.xlsx";
