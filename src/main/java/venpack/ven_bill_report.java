 ...
 */
public class ven_bill_report extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Supplier Bills Report</u></html>");
        setTitle("Supplier Bills Report");
    ...
    void load_report(String dfrom, String dto) {
        try {
            ...
            String query;
            query = "select sno,cname,billno,date_format(dat,'%d/%m/%Y'),date_format(ddate,'%d/%m/%Y'),amount,remarks,user,last from ven_bill where dat between ? and ? order by dat,sno";
            ...
            while (r.next()) {
                ...
                s2.addRow(new Object[]{r.getString(1), r.getString(2), r.getString(3), r.getString(4), r.getString(5), sub2, r.getString(7), r.getString(8), r.getString(9)});
                selva = true;
            }
            sub = 0;
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                sub = sub + Double.parseDouble(jTable1.getValueAt(i, 5).toString());
            }
            String sub2 = String.format("%." + hmany + "f", sub);
            if (selva == true) {
    ...
    public ven_bill_report(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Supplier Bills Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            String file_name = "SupplierBillsReport.xlsx";
