...
public class stock_alter_report extends javax.swing.JInternalFrame {
    ...
    public final void load_list_table() {
        ...
        jTable1.getColumnModel().getColumn(6).setPreferredWidth(184);
        String Ta = "Arial";
        int Bold = 0, size = 14;
    ...
    public stock_alter_report(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Stock Alter Report");
