 ...
 */
public class stock_report_barcode extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Barcode Wise Stock Report</u></html>");
        menu_form me = new menu_form();
        hmany = me.getHmany();
        setTitle("Barcode Wise Stock Report");
    ...
    void load_report() {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select barcode,ino,iname,sum(quan),sum(quan*prate),sum(quan*mrp),sum(quan*rprice),sum(quan*wprice) from stock where cat='" + h3.getSelectedItem() + "' and quan>0 group by barcode,ino order by ino";
            }
            ...
            while (r.next()) {
                ...
                s2.addRow(new Object[]{r.getString(1), r.getString(2), r.getString(3), r.getString(4), prate1, mrp1, srate1, wrate1});
                selva = true;
                prate = 0;
                mrp = 0;
                srate = 0;
            ...
            for (int i = 0; i < jTable1.getRowCount(); i++) {
                quan = quan + Double.parseDouble(jTable1.getValueAt(i, 3).toString());
                prate = prate + Double.parseDouble(jTable1.getValueAt(i, 4).toString());
                mrp = mrp + Double.parseDouble(jTable1.getValueAt(i, 5).toString());
                srate = srate + Double.parseDouble(jTable1.getValueAt(i, 6).toString());
                wrate = wrate + Double.parseDouble(jTable1.getValueAt(i, 7).toString());
            }
            String prate1 = String.format("%." + hmany + "f", prate);
            String mrp1 = String.format("%." + hmany + "f", mrp);
            String srate1 = String.format("%." + hmany + "f", srate);
    ...
    public stock_report_barcode(DataUtil util) {
        initComponents();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Barcode Wise Stock Report");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Barcode Wise Stock Report:\n");
