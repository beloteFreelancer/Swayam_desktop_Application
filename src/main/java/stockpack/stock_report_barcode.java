    ...
    void load_report() {
        try {
            ...
            while (r.next()) {
                ...
                s2.addRow(new Object[] { r.getString(1), r.getString(2), r.getString(3), r.getString(4), prate1, mrp1,
                        srate1, wrate1 });
                selva = true;
                prate = 0;
                mrp = 0;
            ...
            if (selva == true) {
                ...
                s2.addRow(new Object[] { "", "", "TOTAL:" + (jTable1.getRowCount() - 1), quan, prate1, mrp1, srate1,
                        wrate1 });
