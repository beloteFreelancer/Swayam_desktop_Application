    ...
    void load_report() {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select distinct a.ino,a.iname,maxstock,sum(quan) from stock a,item b where a.cat='" + h3.getSelectedItem() + "' and a.ino=b.ino and a.iname=b.iname group by a.ino having sum(quan)> maxstock order by a.iname";
            }
