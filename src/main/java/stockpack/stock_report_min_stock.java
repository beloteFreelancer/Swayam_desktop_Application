 ...
 */
public class stock_report_min_stock extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Minimum Stock Report (Stock Re-Order Report)</u></html>");
        setTitle("Minimum Stock Report (Stock Re-Order Report)");
    ...
    void load_report() {
        try {
            ...
            if (all.isSelected()) {
                ...
                query = "select distinct a.ino,a.iname,minstock,sum(quan) from stock a,item b where a.cat='" + h3.getSelectedItem() + "' and a.ino=b.ino and a.iname=b.iname group by a.ino having sum(quan)< minstock order by a.iname";
            }
            r = util.doQuery(query);
            while (r.next()) {
                long minstock = r.getInt(3);
                long stock = r.getInt(4);
                long diff = minstock - stock;
                s2.addRow(new Object[]{r.getString(1), r.getString(2), minstock, stock, diff});
                selva = true;
            }
    ...
    public stock_report_min_stock(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Minimum Stock Report (Stock Re-Order Report)");
    ...
    private void excelbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excelbuttonActionPerformed
        ...
        try {
            ...
            try (FileWriter f = new FileWriter(new File(folder + "/Drafts/" + file_name + ".xls"))) {
                f.write("Minimum Stock Report (Stock Re-Order Report):\n");
