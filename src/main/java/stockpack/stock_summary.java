 ...
 */
public class stock_summary extends javax.swing.JInternalFrame {
    ...
    final void button_short() {
        ...
        titlelablel.setText("<html><u>Stock Summary</u></html>");
    ...
    public stock_summary(DataUtil util) {
        initComponents();
        this.util = util;
        button_short();
        load_list_table();
    ...
    private void initComponents() {
        ...
        titlelablel.setText("Stock Summary");
        ...
        jScrollPane1.setBounds(0, 72, 1000, 490);
        ...
        generatebutton.setBounds(820, 40, 180, 30);
